...
export default function ProductCard(props) {
  return (
    <div className='shrink-0 snap-start group relative overflow-hidden'>
        ...
        <div className='absolute h-full w-full group-hover:translate-y-[-100%] bg-gradient-to-t from-black/60 to-black/0 transition-all duration-200 bottom-[-100%] z-10 grid place-items-center h-full'>

  ...
  return (
    <div className='hidden md:block py-[10px] w-full'>
        ...
        <div className='pl-[55px] flex flex-col  justify-center'>
            <h1 className='uppercase font-rubik text-[15px] font-[400] text-[#b0b0b0] mb-[3px]'>call us on</h1>
            <h1 className='font-rubik text-[16px] font-[500] text-black leading-[22px]'>{props.data.phone}</h1>
        </div>
        <div className='pl-[55px] flex flex-col justify-center'>
            <h1 className='uppercase font-rubik text-[15px] font-[400] text-[#b0b0b0] mb-[3px]'>office opened</h1>

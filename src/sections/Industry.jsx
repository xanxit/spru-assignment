...
export default function Industry(props) {
  return (
    <div className='w-full pb-[50px] pt-[30px] sm:pt-[70px] text-white bg-gradient-to-br from-[#0061b3] to-[#16bae1]'>
        <div className='px-[15px] text-center xs:max-w-[540px] sm:max-w-[720px] md:max-w-[960px] lg:max-w-[1200px] mx-auto' >

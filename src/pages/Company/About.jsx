        ...
        <div className="max-w-[540px] sm:max-w-[720px] md:max-w-[960px] lg:max-w-[1200px] mx-auto px-[15px]">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="text-justify p-[15px] text-[16px] font-lato font-[400]">
              <p>
                MAGARMACSH division of ASA Industries aims to significantly
                impact the availability of hygiene and sanitation solutions for
                India. The company manufactures Home Care Products for consumers
                under the brand name of Magarmach at a highly affordable price.
                <br />
                <br />
                MM Division currently boasts of world-class, state of the art
                ...
                cleanse products in bottles. <br />
                <br />
                The company is expanding the Housekeeping market in India
              ...
              {page_aboutUs.sections.map((section, index) => {
                return (
                  <div className="" key={index}>
                    <h1 className="text-[24px] font-[600] leading-[24px] mb-[20px]">
                      {section.heading}
                    </h1>
                    <p className="mb-[35px] text-[16px] font-lato">
                      {section.para}
                    </p>
                  </div>
                );
